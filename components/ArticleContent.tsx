...
import {IconArrowLeft, IconShare, IconPrinter} from "@tabler/icons-react";
        ...
        <div className="min-h-screen bg-background relative overflow-x-hidden">
            ...
            <main className="animate-in fade-in duration-1000">
                ...
                <header className="container mx-auto max-w-7xl px-6 pt-12 pb-8">
                    {/* Vol & Date Info */}
                    <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-[0.4em] border-b-2 border-foreground pb-2 mb-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="lg:col-span-7 flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-2">
                                <span className="text-[10px] font-black uppercase tracking-[0.4em] text-primary">Special Correspondent</span>
                            ...
                            {articleData.imageUrl ? (
                                <figure className="relative">
                                    ...
                                    <figcaption className="mt-4 text-[9px] font-bold uppercase tracking-[0.2em] opacity-40 leading-relaxed">
                                        Observed in the {articleData.category} archives. This dispatch covers the primary findings regarding the {articleData.title.toLowerCase()}.
                                    </figcaption>
                                </figure>
                            ) : (
                                <div className="h-full flex flex-col justify-center border-l-2 border-foreground/10 pl-10 py-20 italic text-muted-foreground/40">
                ...
                <footer className="container mx-auto max-w-4xl px-6 py-24 mt-20 border-t-4 border-double border-foreground/30 text-center">
                    <div className="flex flex-col gap-12">
                        <div className="space-y-4">
                            <h3 className="text-4xl font-serif font-black tracking-tighter italic">About the Correspondent</h3>
                            <p className="text-lg text-muted-foreground font-serif leading-relaxed max-w-xl mx-auto opacity-80">
                                {articleData.author} is a lead observer for the MindCanvas Gazette, reporting on the nuances of human experience and technological evolution.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                            ...
                            <button className="px-12 py-5 border-2 border-foreground/20 font-black uppercase tracking-widest text-xs hover:border-foreground transition-colors">
                                Subscribe to Feed
                            </button>
                        </div>
